# -*- coding: utf-8 -*-
"""
Created on Tue May 23 18:43:03 2017
...
def main():
    ...
    #tela_teste = pygame.Surface((MAPWIDTH*TILESIZE,MAPHEIGHT*TILESIZE))
...
#----------------------------------------------------------------------------------------
            if tab == ala_sul.TAB_3: 
                ...
                if arma2_catana_sul == False:
                    ...
                    if arma2_sul_pos.colliderect(A_LUZ1) == True: 
                ...
                if arma3_soco_sul == False:
                    ...
                    if arma3_sul_pos.colliderect(A_LUZ1) == True:
                        tela.blit(martelo,[30*TILESIZE,27*TILESIZE])

                if chave_sul == False:
                    if chave_sul_pos.colliderect(A_LUZ1) == True:
